...
describe("public release contract", () => {
  test("points every current release surface at the canonical Electron artifact", () => {
    ...
    assert.equal(RELEASE, "https://github.com/celados/riffle/releases/tag/v0.4.0");
    assert.equal(
      DMG,
      "https://github.com/celados/riffle/releases/download/v0.4.0/Riffle-0.4.0-mac-arm64.dmg",
    );
